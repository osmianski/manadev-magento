 ...
 *
 */
class ManaPro_ProductFaces_Model_Stock extends Mage_CatalogInventory_Model_Stock {
    protected function _construct() {
        $this->_init('manapro_productfaces/stock');
    }

    public function registerProductsSale($items)
    {
        $qtys = $this->_prepareProductQtys($items);
        $representedProductIds = $this->_prepareRepresentingProductIds($qtys); // MANA
