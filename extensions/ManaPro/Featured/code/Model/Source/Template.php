 ...
 *
 */
abstract class ManaPro_Featured_Model_Source_Template extends Mana_Core_Model_Source_Abstract {
    protected $_rootNode;
    ...
    protected function _getAllOptions() {
        ...
        return array_merge($result, array(
            array('value' => 'custom', 'label' => Mage::helper('manapro_featured')->__('Use Custom Template')),
            array('value' => 'none', 'label' => Mage::helper('manapro_featured')->__('None (Hide)')),
        ));
    }
}