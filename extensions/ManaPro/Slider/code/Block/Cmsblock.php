 ...
 */
class ManaPro_Slider_Block_Cmsblock extends ManaPro_Slider_Block_Abstract {
    ...
    public function getHtml() {
        ...
        $html = $processor->filter($this->getCmsBlock()->getContent());
        return $html;
    }

    public function isVisible() {
        return $this->getCmsBlock() ? true : false;
    }
}