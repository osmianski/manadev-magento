 ...
 *
 */
class Mana_Sitemap_Rewrite_Sitemap extends Mage_Sitemap_Model_Sitemap {
    /**
     * Generate XML file
     *
    ...
    public function generateXml()
    {
        ...
        // invoke standard sitemap generators
        Mage::helper('mana_sitemap')->generateStandardSitemapEntries($io, $baseUrl, $storeId, $date);
