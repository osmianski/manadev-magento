 ...
 *
 */
class Mana_Theme_Block_List_Toolbar extends Mage_Catalog_Block_Product_List_Toolbar {
    protected function _getCustomListModes() {
        /* @var $t Mana_Theme_Helper_Data */
        $t = Mage::helper(strtolower('Mana_Theme'));
    ...
    public function getCurrentMode() {
        ...
        $defaultMode = $this->hasDefaultMode() ? $this->getDefaultMode() : current($modes);
