 ...
 *
 */
class Mana_Content_Router extends Mage_Core_Controller_Varien_Router_Abstract  {
    protected $_route;
    ...
    public function match(Zend_Controller_Request_Http $request) {
        ...
        $urlKey = Mage::getStoreConfig('mana_content/ajax/url_key_filter');
        $routeSeparator = Mage::getStoreConfig('mana_content/ajax/route_separator_filter');
    ...
    public function render() {
        ...
        $js->setConfig('mana_content.url', $url);
