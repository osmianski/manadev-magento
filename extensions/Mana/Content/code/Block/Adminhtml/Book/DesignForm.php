...
class Mana_Content_Block_Adminhtml_Book_DesignForm extends Mana_Content_Block_Adminhtml_Book_AbstractForm {
    ...
    protected function _prepareForm() {
        ...
        $this->addField($fieldset, 'page_layout', 'select', array(
            ...
            'default_bit_no' => Mana_Content_Model_Page_Abstract::DM_PAGE_LAYOUT,
        ...
        $this->addField($fieldset, 'layout_xml', 'textarea', array(
            ...
            'default_bit_no' => Mana_Content_Model_Page_Abstract::DM_LAYOUT_XML,
            'default_store_label' => $this->__('Same For All Stores'),
        ));
        ...
        $this->addField($fieldset, 'custom_design_active_from', 'date', array(
            ...
            'default_bit_no' => Mana_Content_Model_Page_Abstract::DM_CUSTOM_DESIGN_ACTIVE_FROM,
            'default_store_label' => $this->__('Same For All Stores'),
        ));
        ...
        $this->addField($fieldset, 'custom_design_active_to', 'date', array(
            ...
            'default_bit_no' => Mana_Content_Model_Page_Abstract::DM_CUSTOM_DESIGN_ACTIVE_TO,
            'default_store_label' => $this->__('Same For All Stores'),
        ));
        ...
        $this->addField($fieldset, 'custom_design', 'select', array(
            ...
            'default_bit_no' => Mana_Content_Model_Page_Abstract::DM_CUSTOM_DESIGN,
            'default_store_label' => $this->__('Same For All Stores'),
        ));
        ...
        $this->addField($fieldset, 'custom_layout_xml', 'textarea', array(
            ...
            'default_bit_no' => Mana_Content_Model_Page_Abstract::DM_CUSTOM_LAYOUT_XML,
            'default_store_label' => $this->__('Same For All Stores'),
        ));
