 ...
 *
 */
class Mana_AttributePage_Block_Adminhtml_OptionPage_SeoForm extends Mana_AttributePage_Block_Adminhtml_OptionPage_AbstractForm
{
    /**
    ...
    protected function _prepareForm() {
        ...
        $this->addField($fieldset, 'url_key', 'text', array(
            ...
            'default_bit_no' => Mana_AttributePage_Model_OptionPage_Abstract::DM_URL_KEY,
        ...
        $this->addField($fieldset, 'meta_title', 'text', array(
            ...
            'default_bit_no' => Mana_AttributePage_Model_OptionPage_Abstract::DM_META_TITLE,
        ...
        $this->addField($fieldset, 'meta_description', 'textarea', array(
            ...
            'default_bit_no' => Mana_AttributePage_Model_OptionPage_Abstract::DM_META_DESCRIPTION,
            'default_label' => $this->__('Use Title'),
        ...
        $this->addField($fieldset, 'meta_keywords', 'textarea', array(
            ...
            'default_bit_no' => Mana_AttributePage_Model_OptionPage_Abstract::DM_META_KEYWORDS,
            'default_label' => $this->__('Use Option Labels'),
            'default_store_label' => $this->__('Use Option Labels'),
        ));
